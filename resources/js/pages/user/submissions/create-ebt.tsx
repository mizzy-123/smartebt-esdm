            ...
            <div className="mb-8">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                    {isTerbangun
                        ...
                        : 'Input info potensi lokal EBT. Koordinat wajib diisi agar muncul di peta.'}
                </p>
            </div>
            ...
            >
                ...
                <div className="space-y-1.5">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Wajib diisi agar data bisa muncul di peta setelah
                        diverifikasi. Klik peta atau isi manual.
                    </p>
