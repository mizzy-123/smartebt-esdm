...
return new class extends Migration
{
    ...
    {
        Schema::create('submission_plts_perikanan', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('jenis_atap', ['genteng', 'kayu', 'asbes', 'seng', 'lainnya'])->nullable();
            $table->string('jenis_atap_lainnya')->nullable();
            $table->enum('kerangka_atap', ['baja_ringan', 'kayu', 'kanal_c', 'kanal_i', 'beton', 'lainnya'])->nullable();
            $table->string('kerangka_atap_lainnya')->nullable();
            ...
            $table->decimal('daya_peralatan_perikanan', 10, 2)->nullable();
    ...
    {
        Schema::dropIfExists('submission_plts_perikanan');
    }
};
