...
class StorePltsPerikananRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'jenis_atap'                 => ['required', 'in:genteng,kayu,asbes,seng,lainnya'],
            'jenis_atap_lainnya'         => ['required_if:jenis_atap,lainnya', 'nullable', 'string', 'max:255'],
            'kerangka_atap'              => ['required', 'in:baja_ringan,kayu,kanal_c,kanal_i,beton,lainnya'],
            'kerangka_atap_lainnya'      => ['required_if:kerangka_atap,lainnya', 'nullable', 'string', 'max:255'],
            ...
            'daya_peralatan_perikanan'   => ['required', 'numeric', 'min:0'],
